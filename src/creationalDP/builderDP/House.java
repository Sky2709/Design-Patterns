...
public class House {
    ...
    // Optional parameters
    private final int windows; // final because it is initialized in the constructor
    ...
    public static class HouseBuilder {
        // Required parameters
        private final String foundation; // final because it is initialized in the constructor
        private final String structure;
