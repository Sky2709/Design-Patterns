...
public class TrafficController {
    ...
    private Map<String, Road> roads; //map for roadId to road
    ...
    public void handleEmergency(String roadId){
        ...
        if (road!=null){
            TrafficLight trafficLight=road.getTrafficLight();
            trafficLight.changeSignal(Signal.GREEN);
            //logic to handle emergency
            //we will stop the traffic signal for this road
            //then we will start the traffic signal after some time
        }
    }
}
